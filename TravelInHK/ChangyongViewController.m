...
@interface ChangyongViewController ()

@end

@implementation ChangyongViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle]pathForResource:@"yellow" ofType:@"txt"];
...
-(NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
     ...
     return [NSString stringWithFormat:@"香港常用电话"];
