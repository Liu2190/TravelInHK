...
-(void)createTableFooter{
    ...
    else if ([dataArray isEqual:gouwujie ]){
        
    }
    else if ([dataArray isEqual:laozihao ]){
        
    }
    else if ([dataArray isEqual:techandian ]){
        
    }
    else if ([dataArray isEqual:xiaodian ]){
        
    }
    else if ([dataArray isEqual:shangchang]){
        
    }
    else if ([dataArray isEqual:mianshuidian]){
        
    }
    else if ([dataArray isEqual:shudian]){
        
    }
    else if ([dataArray isEqual:outlet ]){
        
    }
    else if ([dataArray isEqual:jishi ]){
        
    }
    else if ([dataArray isEqual:yaozhuang ]){
...
- (void)viewDidLoad
{
    ...
    gouwujie=[[NSMutableArray alloc]init];
 laozihao=[[NSMutableArray alloc]init];
    techandian=[[NSMutableArray alloc]init];
   xiaodian=[[NSMutableArray alloc]init];
    shangchang=[[NSMutableArray alloc]init];
    mianshuidian=[[NSMutableArray alloc]init];
    shudian=[[NSMutableArray alloc]init];
    outlet=[[NSMutableArray alloc]init];
    jishi=[[NSMutableArray alloc]init];
    yaozhuang=[[NSMutableArray alloc]init];
   pingfen=[[NSMutableArray alloc]init];
    juli=[[NSMutableArray alloc]init];
    
    zongshuzu=[[NSMutableArray alloc]initWithObjects:arrayTotal,gouwujie,laozihao,techandian,xiaodian,shangchang,mianshuidian,shudian,outlet,jishi,yaozhuang,pingfen,juli,nil];
    ...
    NSArray *array1=[NSArray arrayWithObjects:@"LV_Class_shopping_",@"LV_Class_shopping_gouwudian",@"LV_Class_shopping_laozihao",@"LV_Class_shopping_techan",@"LV_Class_shopping_xiaodian",@"LV_Class_shopping_shangchang",@"LV_Class_shopping_mianshuidian",@"LV_Class_shopping_shudian",@"LV_Class_shopping_outlet",@"LV_Class_shopping_jishi",@"LV_Class_shopping_yaozhuang",nil];
     array2=[[NSArray alloc]initWithObjects:@"全部类型",@"购物街",@"老字号",@"特产店",@"小店",@"商场",@"免税店",@"书店",@"OUTLET",@"集市",@"药妆",nil];
    ...
    NSArray *arraySelect=[NSArray arrayWithObjects:@"select * from listdo_shopping_main",@"select * from listdo_shopping_main where category='购物街'",@"select * from listdo_shopping_main where category='老字号'",@"select * from listdo_shopping_main where category='特产店'",@"select * from listdo_shopping_main where category='小店'",@"select * from listdo_shopping_main where category='商场'",@"select * from listdo_shopping_main where category='免税店'",@"select * from listdo_shopping_main where category='书店'",@"select * from listdo_shopping_main where category='OUTLET'",@"select * from listdo_shopping_main where category='集市'",@"select * from listdo_shopping_main where category='药妆'",nil];
