...
-(void)createTableFooter{
    ...
    else if ([dataArray isEqual:fengjingmingsheng ]){
        
    }
    else if ([dataArray isEqual:xiuxiandujia ]){
        
    }
    else if ([dataArray isEqual:xiandaijianzhu ]){
        
    }
    else if ([dataArray isEqual:tesejiequ ]){
        
    }
    else if ([dataArray isEqual:youlechang ]){
        
    }
    else if ([dataArray isEqual:gongyuan ]){
        
    }
    else if ([dataArray isEqual:zongjiaochangsuo]){
        
    }
    else if ([dataArray isEqual:xuefu ]){
        
    }
    else if ([dataArray isEqual:guji ]){
        
    }
    else if ([dataArray isEqual:bowugaun ]){
        
    }
    else if ([dataArray isEqual:qita ]){
        
    }
   
    else if([dataArray isEqual:pingfengpaixu]){
...
- (void)viewDidLoad
{
   ...
   img1=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"header-map"]];
    ...
    fengjingmingsheng=[[NSMutableArray alloc]init];
    gongyuan=[[NSMutableArray alloc]init];
    xiandaijianzhu=[[NSMutableArray alloc]init];
    youlechang=[[NSMutableArray alloc]init];
    zongjiaochangsuo=[[NSMutableArray alloc]init];
    tesejiequ=[[NSMutableArray alloc]init];
    qita=[[NSMutableArray alloc]init];
    bowugaun=[[NSMutableArray alloc]init];
    guji=[[NSMutableArray alloc]init];
    xiuxiandujia=[[NSMutableArray alloc]init];
    xuefu=[[NSMutableArray alloc]init];
    pingfengpaixu=[[NSMutableArray alloc]init];
    julipaixu=[[NSMutableArray alloc]init];
    zongshuzu=[[NSMutableArray alloc]initWithObjects:arrayTotal,fengjingmingsheng,xiuxiandujia, xiandaijianzhu, tesejiequ,youlechang,gongyuan, zongjiaochangsuo, xuefu,guji, bowugaun,qita,pingfengpaixu,julipaixu,nil];
    ...
    NSArray *array1=[NSArray arrayWithObjects:@"LV_Class_scenic_",@"LV_Class_scenic_mingsheng",@"LV_Class_scenic_xiuxiandujia",@"LV_Class_scenic_xiandai",@"LV_Class_scenic_tesejiequ",@"LV_Class_scenic_youleyuan",@"LV_Class_scenic_gongyuan",@"LV_Class_scenic_zongjiao",@"LV_Class_scenic_xuefu",@"LV_Class_scenic_guji",@"LV_Class_scenic_bowuguan",@"LV_Class_scenic_qita", nil];
    array2=[[NSArray alloc]initWithObjects:@"全部类型",@"风景名胜",@"休闲度假",@"现代建筑",@"特色街区",@"游乐场",@"公园",@"宗教场所",@"学府",@"古迹",@"博物馆",@"其他", nil];
   ...
   [self.view addSubview:viewDef];
    ...
    NSArray *arraySelect=[NSArray arrayWithObjects:@"select * from listdo_scenic_main",@"select * from listdo_scenic_main where category='风景名胜'",@"select * from listdo_scenic_main where category='休闲度假'",@"select * from listdo_scenic_main where category='现代建筑'",@"select * from listdo_scenic_main where category='特色街区'",@"select * from listdo_scenic_main where category='游乐场'",@"select * from listdo_scenic_main where category='公园'",@"select * from listdo_scenic_main where category='宗教场所'",@"select * from listdo_scenic_main where category='学府'",@"select * from listdo_scenic_main where category='古迹'",@"select * from listdo_scenic_main where category='博物馆'",@"select * from listdo_scenic_main where category='其他'",@"select * from listdo_scenic_main order by score desc",@"select * from listdo_scenic_main order by distance_show desc",nil];
...
-(void)choose1:(UITapGestureRecognizer *)tap{
    ...
    [dataArray addObjectsFromArray:[zongshuzu objectAtIndex:(tap.view.tag-2001+12)]];
    [myTableview reloadData];
    [self createTableFooter];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UILabel *la2=[[UILabel alloc]initWithFrame:CGRectMake(260, 15, 60, 20)];
