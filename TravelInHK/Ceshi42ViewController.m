...
#import "FMDatabase.h"
@interface Ceshi42ViewController ()

@end

@implementation Ceshi42ViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet *set=[db executeQuery:[NSString stringWithFormat:@"select * from listdo_shopping_main where scenicid='%d'",scenicid]];
    while ([set next]) {
        restaurant_name=[set objectForColumnName:@"fullname"];
