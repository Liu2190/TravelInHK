...
@interface FuwutiaokuanViewController ()

@end

@implementation FuwutiaokuanViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle]pathForResource:@"用户使用协议" ofType:@"html"];
